    ...
    <header className="h-14 shrink-0 flex items-center gap-4 px-4 border-b border-border/40 bg-background/80 backdrop-blur-xl z-20">
      ...
      <div className="flex-1 max-w-md">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-2xl border border-border/60 bg-background/50 px-4 py-2 text-sm text-muted-foreground hover:border-border hover:text-foreground transition-all cursor-pointer"
        >
          <Search size={16} />
