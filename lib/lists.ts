...
export const LIST_KINDS: ListKindMeta[] = [
  {
    ...
    presetItems: [
      { name: 'Arroz', quantity: '5kg', category: 'Grãos' },
      { name: 'Feijão', quantity: '1kg', category: 'Grãos' },
      { name: 'Macarrão', quantity: '500g', category: 'Grãos' },
      { name: 'Farinha de trigo', quantity: '1kg', category: 'Grãos' },
      { name: 'Açúcar', quantity: '1kg', category: 'Grãos' },
      { name: 'Café torrado', quantity: '500g', category: 'Grãos' },
      { name: 'Aveia', category: 'Grãos' },
      { name: 'Leite', quantity: '1L', category: 'Laticínios' },
      { name: 'Ovos', quantity: '12', category: 'Laticínios' },
      { name: 'Queijo mussarela', quantity: '200g', category: 'Laticínios' },
      { name: 'Manteiga', quantity: '200g', category: 'Laticínios' },
      { name: 'Iogurte natural', category: 'Laticínios' },
      { name: 'Pão de forma', category: 'Padaria' },
      { name: 'Pão francês', quantity: '10 un', category: 'Padaria' },
      { name: 'Frango', quantity: '2kg', category: 'Carnes' },
      { name: 'Carne moída', quantity: '1kg', category: 'Carnes' },
      { name: 'Bacon', quantity: '200g', category: 'Carnes' },
      { name: 'Banana', quantity: '1 cacho', category: 'Frutas' },
      { name: 'Maçã', quantity: '1kg', category: 'Frutas' },
      { name: 'Laranja', quantity: '1kg', category: 'Frutas' },
      { name: 'Limão', quantity: '500g', category: 'Frutas' },
      { name: 'Alface', category: 'Hortaliças' },
      { name: 'Tomate', quantity: '1kg', category: 'Hortaliças' },
      { name: 'Cebola', quantity: '1kg', category: 'Hortaliças' },
      { name: 'Batata', quantity: '2kg', category: 'Hortaliças' },
      { name: 'Alho', category: 'Hortaliças' },
      { name: 'Água mineral', quantity: '6 un', category: 'Bebidas' },
      { name: 'Refrigerante', quantity: '2L', category: 'Bebidas' },
      { name: 'Suco integral', category: 'Bebidas' },
      { name: 'Detergente', category: 'Limpeza' },
      { name: 'Sabão em pó', quantity: '2kg', category: 'Limpeza' },
      { name: 'Água sanitária', category: 'Limpeza' },
      { name: 'Esponja', category: 'Limpeza' },
      { name: 'Saco de lixo', category: 'Limpeza' },
      { name: 'Papel higiênico', quantity: '12 un', category: 'Higiene' },
      { name: 'Sabonete', quantity: '3 un', category: 'Higiene' },
      { name: 'Shampoo', category: 'Higiene' },
      { name: 'Pasta de dente', category: 'Higiene' },
      { name: 'Sal', quantity: '1kg', category: 'Temperos' },
      { name: 'Óleo', quantity: '900ml', category: 'Temperos' },
      { name: 'Vinagre', category: 'Temperos' },
      { name: 'Orégano', category: 'Temperos' },
      { name: 'Atum', category: 'Enlatados e conservas' },
      { name: 'Molho de tomate', category: 'Enlatados e conservas' },
      { name: 'Chocolate', category: 'Doces e sobremesas' },
      { name: 'Biscoito recheado', category: 'Doces e sobremesas' },
    ],
    combos: [
      {
        id: 'mercado-semana',
        label: 'Compra da semana',
        description: 'O básico da despensa e da geladeira',
        items: [
          { name: 'Arroz', quantity: '5kg', category: 'Grãos' },
          { name: 'Feijão', quantity: '1kg', category: 'Grãos' },
          { name: 'Macarrão', quantity: '500g', category: 'Grãos' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Batata', quantity: '2kg', category: 'Hortaliças' },
          { name: 'Alho', category: 'Hortaliças' },
          { name: 'Abacate', quantity: '2 un', category: 'Frutas' },
        ],
      },
      {
        id: 'mercado-limpeza',
      ...
      },
      {
        id: 'mercado-cafe',
        label: 'Café da manhã',
        description: 'Tudo para começar o dia',
        items: [
          { name: 'Café torrado', quantity: '500g', category: 'Grãos' },
          { name: 'Leite', quantity: '1L', category: 'Laticínios' },
          { name: 'Pão de forma', category: 'Padaria' },
